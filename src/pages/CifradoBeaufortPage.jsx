...
import {useAppForm} from "../hooks/useAppForm.js";
import {useVigenere} from "../hooks/useVigenere.js";

export const CifradoBeaufortPage = () => {
    const {register,
        handleSubmit,
        errors} = useAppForm()
    ...
    return (
        <div className='card '>
            <p className='font-bold'>Cifrado Beaufort :</p>
